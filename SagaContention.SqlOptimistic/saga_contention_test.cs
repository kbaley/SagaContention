...
namespace NServiceBus.Persistence.AcceptanceTests.SagaDataStorage
{
    ...
    public class When_storing_saga_with_high_contention : NServiceBusAcceptanceTest
    {
        ...
        public class SagaEndpoint : EndpointConfigurationBuilder
        {
            ...
            public class HighContentionSaga : SqlSaga<HighContentionSaga.HighContentionSagaData>, IAmStartedByMessages<StartSaga>, IHandleMessages<AdditionalMessage>
            {
                public Context TestContext { get; set; }

                protected override void ConfigureMapping(IMessagePropertyMapper mapper) {
                    mapper.ConfigureMapping<StartSaga>(m => m.SomeId);
                    mapper.ConfigureMapping<AdditionalMessage>(m => m.SomeId);
                }
